...
public record UpdateDrinkRecordRequest(
        @Size(max = 160) String drinkName,
        UUID placeId,
        @Size(max = 160) String shopNameSnapshot,
    ...
    public UpdateDrinkRecord.Command toCommand() {
        return new UpdateDrinkRecord.Command(
                drinkName,
                placeId,
                shopNameSnapshot,
                occurredAt,
